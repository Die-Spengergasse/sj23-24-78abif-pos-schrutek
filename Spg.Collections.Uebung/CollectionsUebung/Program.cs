...
namespace ExCollection.App
{
    public class Klasse
    {
        ...
        //       Liste speichert.
        private List<Schueler> _schuelers = new List<Schueler>();
        public IReadOnlyList<Schueler> Schuelers => _schuelers; // { get { return _schuelers; } }
    ...
    public class Schueler
    {
        ...
        /// Danach wird der Schüler in die neue Klasse mit der korrekter KlasseNavigation eingefügt.
        /// </summary>
        /// <param name="k"></param>
