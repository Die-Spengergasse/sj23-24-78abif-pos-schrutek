...
namespace Spg.CifBazar.Application.Test.Helpers 
{ 
    public static class DatabaseUtilities 
    {
        ...
        public static List<Product> GetSeedingProducts()
        {
            ...
            {
                new Product("Dings", "asddadsdsa", DateOnly.FromDateTime(DateTime.Now.AddDays(30))),
                new Product("Scharubenzieher", "qweeqweqweqw", DateOnly.FromDateTime(DateTime.Now.AddDays(12))),
                new Product("Telefon", "ascxyyxccxy", DateOnly.FromDateTime(DateTime.Now.AddDays(34))),
                new Product("Handy", "cxvxcv", DateOnly.FromDateTime(DateTime.Now.AddDays(32))),
                new Product("T-Shirt", "sfdxvccvbccncnb", DateOnly.FromDateTime(DateTime.Now.AddDays(18))),
                new Product("Socken", "n dfgbadvsf<sdnmgfhdy v", DateOnly.FromDateTime(DateTime.Now.AddDays(92))),
                new Product("Socken2", "xcvyfds ", DateOnly.FromDateTime(DateTime.Now.AddDays(14))),
                new Product("T-Shirt2", "drzjkjhgfhjhfbfvdf", DateOnly.FromDateTime(DateTime.Now.AddDays(71))),
                new Product("Stabmixer", "sdfgtkjhhgfewehtfgbfx", DateOnly.FromDateTime(DateTime.Now.AddDays(25))),
                new Product("Cocal Cola", "fsewertuizoplkhjgfd", DateOnly.FromDateTime(DateTime.Now.AddDays(37))),
                new Product("Bier", "dsafgjhkukjfhdgsadvcx", DateOnly.FromDateTime(DateTime.Now.AddDays(88))),
                new Product("Schneeschaufel", "erwzutkghnbvfetrzukjgh", DateOnly.FromDateTime(DateTime.Now.AddDays(45))),
                new Product("Blumen", "sertzuiokjhgfdcx", DateOnly.FromDateTime(DateTime.Now.AddDays(5))),
                new Product("Wein", "wqertzuiopoiuzhgvcfgnj", DateOnly.FromDateTime(DateTime.Now.AddDays(58))),
                new Product("Unterhose", "mnbvfdertzuiokjhgfc", DateOnly.FromDateTime(DateTime.Now.AddDays(13))),
            };
        }
